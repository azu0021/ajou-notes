...
export default function VeryDailyLog() {
  ...
  useEffect(() => {
    ...
    // 경로: artifacts/very-daily-log/users/{userId}/stock_records
    const q = query(
  ...
  const handleSave = async (formData: any) => {
    ...
    if (finalData.closePrice && finalData.entryPrice && finalData.leverage) {
      ...
      const exitValue = positionSize * (1 + (pnlPercent / 100 / lev)); // Exit value approx
